...
function searchStores() {
    ...
    //arreglo de tiendas para Alajuela
    let alajuelaStores = ["Palmares", "San Ramón", "Grecia"];
    ...
    let storeImages = {
        ...
        "palmares": "sucursalPalmares.jpg",
        "san ramón": "sucursalSanRamon.jpg",
        "grecia": "sucursalGrecia.jpg",
    };
    ...
    let allStores = [...sanJoseStores, ...santaAnaStores, ...herediaStores, ...alajuelaStores];
...
function displayResults(stores, storeImages) {
    ...
    if (stores.length === 0) {
        ...
        for (let i = 0; i < stores.length; i++) {
            ...
            card.innerHTML = `
                <div class="row g-0">
                    <div id="cajaimagenes" class="col-md-4">
                        <img id="imagenes" src="${imageSrc}" class="img-fluid rounded-start" alt="Tienda ${stores[i]}">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
